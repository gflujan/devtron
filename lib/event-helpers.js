...
exports.getEvents = () => {
  const bllrEms = EventsView.getProjectEmitters();
  console.error('bllr ems:', bllrEms.amI);
  ...
  return Eval.execute(() => {
    ...
    // console.debug(
    //   `🚀--BLLR? -> eventHelpers -> projectEmitters from EmitterView ->`,
    //   emitterView.getProjectEmitters(),
    // );
    console.debug(`🚀--BLLR? -> eventHelpers -> incoming args ->`, args);
