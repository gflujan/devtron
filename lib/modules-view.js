...
class ModulesView extends View {
  ...
  async loadGraph() {
    try {
      const mainModule = await modules.getRenderModules();
      console.error('🚀--BLLR?: DEW EYE CEE DIS? 2 ->'); // TODO **[G]** :: 🚀--BLLR?: REMOVE ME!!!
      this.tableDescription.classList.add('hidden');
      console.error('🚀--BLLR?: DEW EYE CEE DIS? 3 ->'); // TODO **[G]** :: 🚀--BLLR?: REMOVE ME!!!
      const suffix = this.getTabLabelSuffix(mainModule);
      console.error('🚀--BLLR?: DEW EYE CEE DIS? 4 ->'); // TODO **[G]** :: 🚀--BLLR?: REMOVE ME!!!
      this.renderProcessTab.textContent = `Renderer Process ${suffix}`;
      console.error('🚀--BLLR?: DEW EYE CEE DIS? 5 ->'); // TODO **[G]** :: 🚀--BLLR?: REMOVE ME!!!
      this.renderRequireRows.innerHTML = '';
      console.error('🚀--BLLR?: DEW EYE CEE DIS? 6 ->'); // TODO **[G]** :: 🚀--BLLR?: REMOVE ME!!!

      if (this.rootRenderView) {
        console.error('🚀--BLLR?: DEW EYE CEE DIS? 7 ->'); // TODO **[G]** :: 🚀--BLLR?: REMOVE ME!!!
        this.rootRenderView.destroy();
      }

      console.error('🚀--BLLR?: DEW EYE CEE DIS? 8 ->', JSON.stringify(this.renderRequireRows)); // TODO **[G]** :: 🚀--BLLR?: REMOVE ME!!!
      this.rootRenderView = new ModuleView(mainModule, this.renderRequireRows);
      console.error('🚀--BLLR?: DEW EYE CEE DIS? 9 ->'); // TODO **[G]** :: 🚀--BLLR?: REMOVE ME!!!
